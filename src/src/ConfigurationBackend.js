...
var ConfigurationBackend = /** @class */ (function () {
    ...
    ConfigurationBackend.prototype.merge = function (obj) {
        return __awaiter(this, void 0, void 0, function () {
            var merged;
            return __generator(this, function (_a) {
                merged = merge(this.real_object, obj, { clone: true });
                this.real_object = merged;
                return [2 /*return*/, this];
            });
        });
    };
    ConfigurationBackend.prototype.getObject = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.real_object];
            });
        });
    };
    ConfigurationBackend.prototype.get = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var _key, _value;
            return __generator(this, function (_a) {
    ...
    ConfigurationBackend.prototype.set = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (null === key || undefined === key)
                    throw new Error('Key cannot be empty');
